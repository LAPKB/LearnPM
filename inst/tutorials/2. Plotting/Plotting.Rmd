...
<!-- ```{r density_final_plot-code-check}
gradethis::grade_this_code()
``` -->

This plot can also generate bicariate plots by supplying the appropiate formulate using the R syntax `x~y`:
