...
As seen in the model builder app, `PM_model` objects can be [plotted](https://lapkb.github.io/Pmetrics/reference/plot.PM_model.html).
...
modEx$plot()
```
In this case, the model is analytic (This means that the user has not specified a set )
