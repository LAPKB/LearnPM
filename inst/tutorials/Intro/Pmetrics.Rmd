---
title: "Fit models using Pmetrics"
tutorial:
    id: "fit-models"
output: 
  learnr::tutorial:
...
# Installing Pmetrics
Before getting into the topic, make sure you have the latest version of bot [R](https://cran.r-project.org/) and [Rstudio][https://posit.co/download/rstudio-desktop/].
...
## Let's get some data! PM_tutorial()
